...
router.get('/:id/tracking-url', (req, res) => {
  ...
  const urls = {
    ...
    branch:    `${base}/track/click/${c.campaign_token}?~channel={channel}&~campaign=${encodeURIComponent(c.name)}&~feature=paid_advertising&clickid={publisher_click_id}&advertising_id={advertising_id}&sub1={sub1}`,
    impact:    `${base}/track/click/${c.campaign_token}?irclickid={irclickid}&mediapartnerid={media_partner_id}&clickid={irclickid}&sub1={sub1}&advertising_id={advertising_id}`,
